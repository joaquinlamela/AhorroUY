    ...
    public partial class UserSession : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsMarkets", x => new { x.ProductId, x.MarketId });
                    table.ForeignKey(
                        name: "FK_ProductsMarkets_Market_MarketId",
                        column: x => x.MarketId,
                        principalTable: "Market",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsMarkets_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsMarkets_MarketId",
                table: "ProductsMarkets",
                column: "MarketId");
        }
